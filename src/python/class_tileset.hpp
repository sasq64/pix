...
inline void add_tileset_class(py::module_ const& mod)
{
    ...
    ts.def(py::init<>(&make_tileset), "font_file"_a, "size"_a,
        ...
        .def(
            "get_image_for", &TileSet::get_texture_for_char,
