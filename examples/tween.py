...
class Ease:
    ...
    def in_out_elastic(t: float) -> float:
        ...
        return (
            ...
            if t < 0.5
            else (2 ** (-20 * t + 10) * math.sin((20 * t - 11.125) * c5)) / 2 + 1
        )
...
def tween[T: Tweenable](
    start: T, stop: T, steps: int, ease: Callable[[float], float] = Ease.out_sine
